            ...
            <div id="panel-group">
                ...
                <div class="panel panel-primary" style="opacity: 0.9;">
                    <div class="panel-heading">
                        <h3 class="panel-title">教学任务信息</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table">
                            ...
                            <form action="/course" method="post">
                                <tr>
                                    <th></th>
                                    <th><input name="cid" value="${course.cid}" readonly></th>
                                    <th><input name="cName" value="${course.cName}" required></th>
                                    <th><input name="cScore" value="${course.score}" required></th>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th>
                                        <button type="submit" class="btn btn-warning">修改课程信息</button>
                                    </th>
                                    <th></th>
                                </tr>
                            </form>
