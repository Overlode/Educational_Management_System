    ...
    <div class="container" style="margin-left: 8%;">
        ...
        <div class="collapse navbar-collapse" id="demo-navbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li style="background-color: dodgerblue;color: white"><a href="/teacher/stu-list" style="color: white">学生奖惩</a>
                </li>
            ...
            <div id="panel-group">
                ...
                <div class="panel panel-primary" style="opacity: 0.9;">
                    <div class="panel-heading">
                        <h3 class="panel-title">添加奖惩信息</h3>
                    </div>
                    <div class="panel-body">
                        <form action="/teacher/stu-list/add" method="post">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th>姓名</th>
                                    <th><input value="${student.name}" readonly></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <th>学号</th>
                                    <th><input name="sid" value="${student.id}" readonly></th>
                                </tr>
                                <tr>
                                    <th>日期</th>
                                    <th>
