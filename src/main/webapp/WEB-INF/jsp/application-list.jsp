    ...
    <div class="container" style="margin-left: 8%;">
        ...
        <div class="collapse navbar-collapse" id="demo-navbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li style="background-color: dodgerblue;color: white"><a href="/teacher/application-list"
                                                                         style="color: white">审核管理</a></li>
                ...
                <div class="panel panel-primary" style="opacity: 0.9;">
                    ...
                    <div class="panel-body">
                        <table class="table">
                            ...
                            <tbody>
                            <c:forEach items="${passrequests }" var="p" varStatus="i">
                                <tr>
                                    <th>${p.id}</th>
                                    <th>${p.sid}</th>
                                    <c:if test="${p.confirm==0}">
                                        <th>未审核</th>
                                        <th><a href="/teacher/application-teacher/check?sid=${p.sid}">操作</a></th>
                                    </c:if>
                                    <c:if test="${p.confirm==1}">
                                        <th>未通过</th>
                                        <th></th>
                                    </c:if>
                                    <c:if test="${p.confirm==2}">
                                        <th>已通过</th>
                                        <th></th>
                                    </c:if>
                                </tr>
