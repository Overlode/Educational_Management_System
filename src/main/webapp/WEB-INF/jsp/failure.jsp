...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url("/assets/image/blueprint.png") repeat 0 0;
        }
        ...
        div.da-error-wrapper .da-error-code {
            ...
            font-size: 32px;
            text-align: center;
            background: url("/assets/image/error-hanger.png") no-repeat center center;
        ...
        div.da-error-wrapper .da-error-pin {
            ...
            z-index: 10;
            position: relative;
            background: url("/assets/image/error-pin.png") no-repeat center center
        }
        ...
        <div class="da-container clearfix">
            <div class="da-error-wrapper">
                ...
                <div class="da-error-code">
                    <p class="tip">${errorMessage.tip1}</p>
                    <p class="tip2">${errorMessage.tip2}</p>
                    <p class="tip3">${errorMessage.tip3}</p>
                </div>
            </div>
        </div>
    </div>
